      ...
      <AnswerVisibility field={f.cryptographyAnswers}>
        <Content>
          <Section first>
            <Prose>
              <p>
                As before, we have an entangled initial state and two observers.
                Here are some definitions for this page:
              </p>
              ...
              <p>
                Assume Alice and Bob (the two observers) always choose either X
          ...
          <Section commits={f.cryptographyIntroCommit}>
            <Choice
              ...
              label={
                <Prose>
                  Bob use an SG oriented along the X axis and measures a 1. If
                  Alice measures a 0, which of the following is true?
                </Prose>
              }
              choices={aliceSGChoices}
              answer="either"
              explanation="No way to know with a single outcome."
            />
          ...
          <Section commits={f.bX1A1Commit}>
            <Choice
              ...
              label={
                <Prose>
                  <p>
                    If Alice uses a SG oriented along the Z axis and measures a
                    0, what is the likelihood that Bob measures a 1?
                  </p>

                  <p>
                    Hint: Recall that Bob <em>randomly</em> (with 50/50 odds)
                    orients his SG either along the X or Z axis.
                  </p>
                </Prose>
              }
              ...
              explanation={
                <p>
                  If Bob measures Z, the likelihood is 100%, but if he measures
                  X, it’s 50%. Since the measurement he chooses is random, and
                  thus each occurs half the time, the overall likelihood is
                  <M t="100\% * ½ + 50\% * ½ = 75\%" />.
                </p>
              }
            />
            ...
            <Choice
              ...
              label={
                <Prose>
                  <p>
                    If Alice uses a SG oriented along the Z axis and measures a
                    1, what is the likelihood that Bob measures a 1?
                  </p>

                  <p>
                    Hint: Recall that Bob randomly orients his SG either along
                    the X or Z axis.
                  </p>
                </Prose>
              }
              ...
              explanation={
                <p>
                  If Bob measures Z, the likelihood is 0%. If he measures X,
                  it’s 50%. The overall likelihood is
                  <M t="0\% * ½ + 50\% * ½ = 25\%" />.
                </p>
              }
            />
          ...
          <Section commits={f.aZ0B1ProbCommit}>
            <Choice
              ...
              label={
                <Prose>
                  If Bob and Alice both use SGs oriented along the Z axis,
                  choose ALL statements that are true. (There may be more than
                  one.)
                </Prose>
              }
            ...
            <Choice
              ...
              label={
                <Prose>
                  ...
                  oriented along the Z axis. Choose ALL statements that are
          ...
          <RevealAnswersSection
            commits={f.causalityCommit /* TODO! */}
