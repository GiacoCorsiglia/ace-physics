      ...
      <SVG width={width} height={height} center className={styles.graph}>
        {(svg) => (
          <>
            ...
            {state.k === "ij" && <Vector {...svg.position(...k)} color="red" />}
            {state.k === "ij" && (
              <M
                t="{\color{red} \ket{k}}"
                inSvg
        ...
        <div>
          <ul>
            <Button
              ...
              dispatch={dispatch}
            >
              Add <M t="\vb{v1}" /> and <M t="\vb{v2}" /> labels to the
        ...
        <div>
          <ul>
            <Button active={state.k === "ij"} option="ij" dispatch={dispatch}>
              Plot <M t="\ket{k}" /> against the <M t="\vb{i}" /> and{" "}
              <M t="\vb{j}" /> axes.
            </Button>
            ...
            <Button
              ...
              dispatch={dispatch}
            >
              Plot <M t="\ket{k}" /> against the <M t="\vb{v1}" /> and{" "}
              <M t="\vb{v2}" /> axes.
            </Button>
          </ul>
        </div>
