      ...
      body: (m) => (
        <>
          <Toggle
            ...
            label={
              <Prose>
                <strong> Question 3: </strong>I send you a string of qubits, one
                at a time. Each qubit is either in state <M t="\ket{0}" /> or in
                state <M t="\ket{1}" />. I use an ideal random coin toss to
                decide what to send for each qubit, with exactly 50/50
                probabilty every time. <br />
                <br />
