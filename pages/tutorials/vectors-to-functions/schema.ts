...
export default s.tutorial({
  ...
  responses: {
    ...
    halfIntegerPossibleMeasurements: s.string(false),
    halfIntegerColumnElements: s.string(false),
    halfIntegerBasisStates: s.string(false),
    halfIntegerDiracNotation: s.string(false),
    addMorePoints: s.boolean(),
    smooth: s.boolean(),
    smoothPossibleMeasurements: s.string(false),
    smoothBasisStates: s.string(false),
    xiLabel: s.string(false),
