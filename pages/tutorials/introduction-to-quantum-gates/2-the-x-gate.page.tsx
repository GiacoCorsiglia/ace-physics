...
export default page(setup, ({ section, hint }) => ({
  ...
  sections: [
    section({
      ...
      body: (
        <Prose>
          To perform any tasks on our quantum computer, we need to apply{" "}
          <strong>gates</strong>. (like in a classical computer, where we have
          the NOT gate and the OR gate). When a gate acts on a state, the result
          is another state. These gates take the form of quantum mechanical
          operators. We will go over some of the more common gates for quantum
          computers.
        </Prose>
      ),
      continue: {
          ...
          <TextBox
            ...
            label={
              <Prose>
                ...
                <br />
                <em>
                  You can type a ket using the <code>|</code> and{" "}
                  <code>{">"}</code> keys, such as |0{">"}.
                </em>
              </Prose>
            }
          />
        ...
        messages: {
          answer: {
            body: (
              <Guidance.HeadsUp>
                <p>
                  Our answer is: <M t="\frac{1}{5}\pmatrix{-4 \\ 3i}" />.
                </p>

                <p>
                  Recall, the <M t="X" /> gate is written in matrix notation as{" "}
                  <M display t="X = \pmatrix{0 & 1 \\ 1 & 0}" />
                </p>
              </Guidance.HeadsUp>
            ),
