...
export default page(setup, ({ section, oneOf }) => ({
  ...
  sections: [
    ...
    section({
      ...
      body: (m) => (
        <Dropdown
          ...
          label={<Prose>For qubit 1, what state does Alice send to Bob?</Prose>}
          choices={[
            ["+z", <M t="{\ket{0}}" />],
            ["-z", <M t="{\ket{1}}" />],
            ["+x", <M t="{\ket{+}}" />],
          ...
          dynamicAnswer: {
            body: ({ responses }) => (
              ...
              >
                {responses?.qubit1AliceToBob?.selected !== "+z" ? (
                  <p>
                    Notice that for qubit 1, Alice wants to send 0 and does not
                    apply a Hadamard, so the qubit is unchanged. Feel free to
                    change your answer.
                  </p>
                ) : (
                  <p>
                    Yes! Alice wants to send 0 and does not apply a Hadamard, so
                    the qubit is unchanged.
                  </p>
                )}
              </Guidance.Dynamic>
            ),
        ...
        <>
          <LabelsLeft>
            <Dropdown
              ...
              label={
                <Prose>For qubit 2, what state does Alice send to Bob?</Prose>
              }
              choices={[
                ["+z", <M t="{\ket{0}}" />],
                ["-z", <M t="{\ket{1}}" />],
            ...
            <Dropdown
              ...
              label={
                <Prose>For qubit 5, what state does Alice send to Bob?</Prose>
              }
              choices={[
                ["+z", <M t="{\ket{0}}" />],
                ["-z", <M t="{\ket{1}}" />],
      ...
      guidance: {
        ...
        messages: {
          ...
          incorrect: {
            body: (
              <Guidance.Disagree>
                Looks like we disagree with at least one of your answers for
                Alice's states. Recall the effect of the Hadamard gate on a
                qubit:
                <p>
                  <center>
                    <M t="H\ket{0} = \ket{+}" /> <br />
    ...
    section({
      ...
      body: (m, s) => (
        <>
          <Prose>
            {" "}
            Use the information in the table to determine whether or not Alice
            applied a Hadamard to the following qubits.
          </Prose>
          <LabelsLeft>
            <Dropdown
        ...
        messages: {
          correct: {
            body: (
              <Guidance.Agree>
                {" "}
                We agree! On qubit 8, Alice's Hadamard converted the{" "}
                <M t="\ket{1}" /> to a <M t="\ket{-}" />. For qubit 9, Alice did
                not operate on the qubit.
              </Guidance.Agree>
            ),
            onContinue: "nextSection",
          },
          incorrect: {
            body: (
              <Guidance.Disagree>
                We disagree with at least one of your answers. Since Alice's bit
                is a 1, she starts with the <M t="\ket{1}" />
                state and either applies a Hadamard or not. Feel free to change
                your answer(s).
              </Guidance.Disagree>
            ),
            onContinue: "nextMessage",
    ...
    section({
      ...
      body: (m, s) => (
        <>
          <Prose>
            {" "}
            For qubits 10 and 11, use the information in the table to determine
            which is the value of Alice's bit.
          </Prose>
          <LabelsLeft>
            <Dropdown
              model={m.qubit10AlicesBit}
              label={<Prose>Qubit 10:</Prose>}
              choices={[
                ["0", <M t="0" />],
                ["1", <M t="1" />],
      ...
      guidance: {
        ...
        messages: {
          ...
          incorrect: {
            body: (
              <Guidance.Disagree>
                We disagree with at least one of your answers. Take another look
                and feel free to change your answers.
              </Guidance.Disagree>
            ),
            onContinue: "nextMessage",
          },
    ...
    section({
      ...
      body: (m) => (
        <>
          ...
          />
          <Prose>
            Note that in all cases where the outcome was “random”, a letter "R"
            is listed. This is what Bob got!
          </Prose>
        </>
      ),
      continue: {
    ...
    section({
      ...
      body: (m) => (
        <Dropdown
          ...
          label={<Prose>For qubit 2, what is the value of Bob's bit?</Prose>}
          choices={[
            ["0", <M t="0" />],
            ["1", <M t="1" />],
            ["random", "Random"],
              ...
              >
                {responses?.qubit2BobsBit?.selected !== "0" ? (
                  <p>
                    ...
                    <M t="{H\ket{+}=\ket{0}}" />, which has a 100% chance of
                    being measured to be 0.
                  </p>
                ) : (
                  <p>
                    {" "}
                    We agree. Qubit 2 comes to Bob as a <M t="\ket{+}" />. Since
                    Bob applies a Hadamard, he ends up measuring
                    <M t="{H\ket{+}=\ket{0}}" />, which has a 100% chance of
                    being measured to be 0.
                  </p>
                )}
    ...
    section({
      ...
      body: (m, s) => (
        <>
          <Prose> For qubits 3 and 4, what are the values of Bob's bits?</Prose>
          <LabelsLeft>
            <Dropdown
              model={m.qubit3BobsBit}
              label={<Prose>Qubit 3:</Prose>}
              choices={[
                ["0", <M t="0" />],
                ["1", <M t="1" />],
                ["random", "Random"],
        ...
        messages: {
          correct: {
            body: (
              <Guidance.Agree>
                {" "}
                Correct! Great job! In the case of qubit 3, the result is
                random, and Bob might have a 0 or a 1. We'll see how to deal
                with this soon!
              </Guidance.Agree>
            ),
            onContinue: "nextSection",
          ...
          incorrect: {
            body: (
              <Guidance.Disagree>
                We disagree with at least one of your answers. Remember that if
                Bob makes a measurement on a state that is <M t="\ket{+}" />
                or <M t="\ket{-}" />, his result will be random. Feel free to
                change your answers.
              </Guidance.Disagree>
            ),
            onContinue: "nextMessage",
              ...
              >
                {responses?.qubit6ApplyH?.selected !== "no" ? (
                  <p>
                    ...
                    <M t="\ket{+}" /> state he was sent, so he is measuring a{" "}
                    <M t="\ket{+}" /> qubit. Is the outcome (0 or 1) random or
                    determined? Feel free to change your answer.
                  </p>
                ) : (
                  <p>
                    {" "}
                    Yes we agree. Bob did not apply a Hadamard to the
                    <M t="\ket{+}" /> state that he was sent. When measuring a{" "}
                    <M t="\ket{+}" /> qubit, the outcome is random (with 50/50
                    odds of getting 0 or 1).
                  </p>
                )}
              </Guidance.Dynamic>
            ),
    ...
    section({
      ...
      body: (m, s) => (
        <>
          <Prose>
            {" "}
            For qubits 7 and 10, did Bob apply a Hadamard before he measured?
          </Prose>
          <LabelsLeft>
            <Dropdown
              model={m.qubit7ApplyH}
              label={<Prose>Qubit 7:</Prose>}
              choices={[
                ["yes", "Yes"],
                ["no", "No"],
                ["unknown", "Unknown"],
        ...
        messages: {
          correct: {
            body: (
              <Guidance.Agree>
                {" "}
                We agree! For qubit 7, since we know that Bob's measurement will
                be 0 with certainty, he must have measured the state{" "}
                <M t="\ket{0}" />, which is what Alice sent, so he did not apply
                a Hadamard. But for qubit 10, the fact that his measurement was
                random tells us he performed a measurement on either the{" "}
                <M t="\ket{+}" /> or <M t="\ket{-}" /> state. (In this case,
                given what Alice sent, it must have been a
                <M t="\ket{+}" />)
              </Guidance.Agree>
            ),
            onContinue: "nextSection",
          ...
          incorrect: {
            body: (
              <Guidance.Disagree>
                ...
                on a <M t="\ket{0}" /> or <M t="\ket{1}" />
                .If it is random, he must have made a measurement on a{" "}
                <M t="\ket{+}" /> or
    ...
    section({
      ...
      body: (m) => (
        <>
          <Prose>
            {" "}
            Note that on this page, you can see the entire table with
            information that includes or not Bob's measurement results were
            random or certain. Without talking to Alice, does Bob know whether
            the result he got was "certain" or "random"?
          </Prose>
          <Toggle
          ...
          dynamicAnswer: {
            body: ({ responses }) => (
              ...
              >
                {responses?.certainOrRandom?.selected !== "no" ? (
                  <p>
                    We disagree with your answer. In practice, Bob has no way of
                    knowing whether his measurement outcome was certain to occur
                    or the result of chance. He doesn't know what qubit state
                    Alice sent him. Feel free to change your answer.
                  </p>
                ) : (
                  <p>
                    {" "}
                    We agree with your answer. In practice, Bob has no way of
                    knowing whether his measurement outcome was certain to occur
                    or the result of chance. He doesn't know what qubit state
                    Alice sent him.
                  </p>
