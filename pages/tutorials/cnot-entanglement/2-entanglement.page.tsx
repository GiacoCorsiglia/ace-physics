      ...
      body: (
        <Prose>
          <p>
            ...
            <M t="{ \ket{00}, \ket{01}, \ket{10}, \ket{11}\}" /> form a basis
            for the two-qubit space. Another valid basis is the “Bell Basis”,
            which consists of four linearly independent entangled states (known
            as the Bell states).
          </p>
          <M
            display
